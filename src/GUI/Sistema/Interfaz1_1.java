 ...
 * @author Christian
 */
public class Interfaz1_1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextFieldUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 180, 170, -1));

        jPasswordFieldContraseña.setBackground(new java.awt.Color(0, 51, 255));
        getContentPane().add(jPasswordFieldContraseña, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, 170, -1));

        jLabel1Icono.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/User.png"))); // NOI18N
        jLabel1Icono.setText("jLabel1");
        getContentPane().add(jLabel1Icono, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 10, 250, -1));
        ...
        getContentPane().add(jLabelFondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 452, -1));
